...
namespace AnimalCollection.Migrations
{
    ...
    [Migration("20220108013728_Seed_Data_For_Animal")]
    partial class Seed_Data_For_Animal
    {
            ...
            modelBuilder.Entity("AnimalCollection.Entities.Animal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AnimalTypeId = 1,
                            CreatedDate = new DateTime(2022, 1, 8, 2, 37, 27, 624, DateTimeKind.Local).AddTicks(1780)
                        },
                        new
                        {
                            AnimalId = 2,
                            ...
                            AnimalTypeId = 2,
                            CreatedDate = new DateTime(2022, 1, 8, 2, 37, 27, 624, DateTimeKind.Local).AddTicks(4510)
                        },
                        new
                        {
                            AnimalId = 3,
                            ...
                            AnimalTypeId = 2,
                            CreatedDate = new DateTime(2022, 1, 8, 2, 37, 27, 624, DateTimeKind.Local).AddTicks(4710)
                        },
                        new
                        {
                            AnimalId = 4,
                            ...
                            AnimalTypeId = 3,
                            CreatedDate = new DateTime(2022, 1, 8, 2, 37, 27, 624, DateTimeKind.Local).AddTicks(4940)
                        },
                        new
                        {
                            AnimalId = 5,
